# PLL SG13CMOS5L layout record — `20260922-194122-7980bfe-dirty`
...
## Verdict: **491 / 491 devices drawn**, **491 / 491 DRC-clean**, **491 / 491 re-extracted matching the schematic**; 6 / 6 blocks composed and routed (256 nets), 6 DRC-clean, 6 device-count-matched, **4 / 6 LVS `match`**
...
| `vco` | 15/15 | 45 | 45 | 45 | 45 | yes | 33 | clean | yes | **mismatch** (devices 39/45, nets 25/34) |
...
- `vco` — **mismatch**, devices 39/45, nets 25/34, pins 33/6; `mismatch_count` 8 (device.unmatched: 6, net.merged: 1, topology.flattened: 1)
