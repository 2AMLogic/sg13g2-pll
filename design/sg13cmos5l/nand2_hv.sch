...
sg13g2-pll :: nand2_hv -- 2-input static CMOS NAND
...
S {}
E {}
C {sg13cmos5l_pr/sg13_hv_pmos.sym} 0 -100 0 0 {name=MP1 model=sg13_hv_pmos w=5u l=0.5u ng=1 m=1 spiceprefix=X}
...
C {sg13cmos5l_pr/sg13_hv_pmos.sym} 150 -100 0 0 {name=MP2 model=sg13_hv_pmos w=5u l=0.5u ng=1 m=1 spiceprefix=X}
...
C {sg13cmos5l_pr/sg13_hv_nmos.sym} 0 150 0 0 {name=MN1 model=sg13_hv_nmos w=2u l=0.5u ng=1 m=1 spiceprefix=X}
C {lab_pin.sym} -20 150 0 0 {name=l9 lab=A1}
C {lab_pin.sym} 20 120 0 0 {name=l10 lab=Y}
C {lab_pin.sym} 20 180 0 0 {name=l11 lab=mid1}
C {lab_pin.sym} 20 150 0 0 {name=l12 lab=VSS}
C {sg13cmos5l_pr/sg13_hv_nmos.sym} 150 150 0 0 {name=MN2 model=sg13_hv_nmos w=2u l=0.5u ng=1 m=1 spiceprefix=X}
C {lab_pin.sym} 130 150 0 0 {name=l13 lab=A2}
C {lab_pin.sym} 170 120 0 0 {name=l14 lab=mid1}
C {lab_pin.sym} 170 180 0 0 {name=l15 lab=VSS}
C {lab_pin.sym} 170 150 0 0 {name=l16 lab=VSS}
...
C {iopin.sym} -250 600 0 0 {name=p5 lab=VSS}
