...
S {}
E {}
C {sg13cmos5l_pr/sg13_hv_pmos.sym} 0 -300 0 0 {name=MPH model=sg13_hv_pmos w=10u l=0.5u ng=1 m=1 spiceprefix=X}
C {sg13cmos5l_pr/sg13_hv_pmos.sym} 0 0 0 0 {name=MP model=sg13_hv_pmos w=5u l=0.28u ng=1 m=1 spiceprefix=X}
C {sg13cmos5l_pr/sg13_hv_nmos.sym} 0 300 0 0 {name=MN model=sg13_hv_nmos w=2u l=0.28u ng=1 m=1 spiceprefix=X}
C {sg13cmos5l_pr/sg13_hv_nmos.sym} 0 600 0 0 {name=MNT model=sg13_hv_nmos w=4u l=0.5u ng=1 m=1 spiceprefix=X}
