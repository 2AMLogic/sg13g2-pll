...
S {}
E {}
C {sg13g2_pr/sg13_hv_pmos.sym} 0 -150 0 0 {name=MP1 model=sg13_hv_pmos w=5u l=0.5u ng=1 m=1 spiceprefix=X}
C {sg13g2_pr/sg13_hv_pmos.sym} 0 -50 0 0 {name=MP2 model=sg13_hv_pmos w=5u l=0.5u ng=1 m=1 spiceprefix=X}
...
C {sg13g2_pr/sg13_hv_nmos.sym} 300 100 0 0 {name=MN1 model=sg13_hv_nmos w=2u l=0.5u ng=1 m=1 spiceprefix=X}
C {sg13g2_pr/sg13_hv_nmos.sym} 500 100 0 0 {name=MN2 model=sg13_hv_nmos w=2u l=0.5u ng=1 m=1 spiceprefix=X}
