...
S {}
E {}
C {sg13g2_pr/sg13_hv_pmos.sym} 0 -100 0 0 {name=MP model=sg13_hv_pmos w=10u l=0.5u ng=1 m=1 spiceprefix=X}
C {sg13g2_pr/sg13_hv_nmos.sym} 0 100 0 0 {name=MN model=sg13_hv_nmos w=4u l=0.5u ng=1 m=1 spiceprefix=X}
