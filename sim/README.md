...
Tracks issues #81, #82 (Part of #16 via #78) and #97. #81/#82 are Phases 1/2
and 2/2 of the decomposition #78's own Scope section calls for ("stand up
the slug + extract R/C" then "re-derive and re-measure"); both have landed.
#97 is a second, independent SG13G2 slug — the SG13G2 twin of the
SG13CMOS5L port's own `sg13cmos5l-vco-kvco-table` (issue #23).
